...
object ejemplo {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(444); 
...
};System.out.println("""main: (args: Array[String])Unit""");$skip(1524); 
  ...
  };System.out.println("""seleccionNivel: (nivel: Int)Unit""");$skip(769); 
  ...
  def jugada(movimientos:Int, tablero:List[Int],fil:Int,col:Int, max:Int):Unit = {
...
};System.out.println("""jugada: (movimientos: Int, tablero: List[Int], fil: Int, col: Int, max: Int)Unit""");$skip(176); 
   ...
   };System.out.println("""obtenerColor: (l: List[Int], pos: Int)Int""");$skip(325); 
  ...
  def generarAle(l:List[Int], max:Int): List[Int] = {
   ...
   };System.out.println("""generarAle: (l: List[Int], max: Int)List[Int]""");$skip(205); 
  ...
  };System.out.println("""imprimirCabecera: (col: Int, num: Int)Unit""");$skip(195); 
  ...
  };System.out.println("""imprimirTablero: (l: List[Int], col: Int, fil: Int)Unit""");$skip(466); 
...
def imprimir_aux(l:List[Int],salto:Int,n:Int,fil:Int,fil_final:Int):Unit = {
  ...
  };System.out.println("""imprimir_aux: (l: List[Int], salto: Int, n: Int, fil: Int, fil_final: Int)Unit""");$skip(193); 
...
def imprimirTablero2(l:List[Int],col:Int,fil:Int) ={
  ...
  };System.out.println("""imprimirTablero2: (l: List[Int], col: Int, fil: Int)Unit""");$skip(262); 
...
};System.out.println("""imprimir_cabeza: (num: Int)Unit""");$skip(487); 
...
def imprimir_aux2(l:List[Int],salto:Int,n:Int,fil:Int,fil_final:Int):Unit = {
  ...
  };System.out.println("""imprimir_aux2: (l: List[Int], salto: Int, n: Int, fil: Int, fil_final: Int)Unit""");$skip(424); 
...
def Poner (l: List [Int], color: Int, posición: Int): List [Int] = posición match {
 ...
 def generarTablero(col:Int): List[Int] = col match{
	  ...
	  };System.out.println("""Poner: (l: List[Int], color: Int, posici�: <error>)Unit""")}
 }
