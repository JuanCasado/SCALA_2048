...
object ejercicios {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(288); 
  ...
  def generarTablero(col:Int): List[Int] = col match{
	...
	};System.out.println("""generarTablero: (col: Int)List[Int]""");$skip(291); 
  ...
  };System.out.println("""poner: (l: List[Int], color: Int, posicion: Int)List[Int]""");$skip(221); 
  ...
  };System.out.println("""poner2: (l: List[Int], color: Int)List[Int]""");$skip(4498); 
  ...
  };System.out.println("""obtenerElementos: (l: List[Int], pos: Int, fil: Int, col: Int, color: Int)List[Int]""");$skip(82); 
 	
  def imprimirTablero(l:List[Int],col:Int) ={
  		imprimir_aux(l,col-1,0)
  };System.out.println("""imprimirTablero: (l: List[Int], col: Int)Unit""");$skip(307); 
  ...
  def imprimir_aux(l:List[Int],salto:Int,n:Int):Unit = {
  ...
  };System.out.println("""imprimir_aux: (l: List[Int], salto: Int, n: Int)Unit""");$skip(358); 
   ...
   };System.out.println("""generarAle: (l: List[Int])List[Int]""");$skip(216); 
   ...
   def obtenerColor(l:List[Int], pos:Int): Int={
   ...
   };System.out.println("""obtenerColor: (l: List[Int], pos: Int)Int""");$skip(519); 
    ...
    };System.out.println("""eliminarPos: (l: List[Int], fil_eli: Int, col_eli: Int, col: Int, fil: Int)List[Int]""");$skip(166); 
    
    //eliminamos la ficha
    def eliminar_aux(l:List[Int],n:Int):List[Int] = {
    	if(n==0) List(0):::l.tail
    	else l.head::eliminar_aux(l.tail,n-1)
    };System.out.println("""eliminar_aux: (l: List[Int], n: Int)List[Int]""");$skip(47); 
